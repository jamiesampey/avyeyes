...
5. I then email/link/post/message/tweet/share the report with anyone on the internet using the unique report URL https<nolink>://avyeyes.com/8charUID so that everyone can see the avalanche online in an interactive 3D view
