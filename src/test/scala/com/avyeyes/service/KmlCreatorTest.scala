...
class KmlCreatorTest extends WebSpec2 with AvalancheHelpers {
  ...
  val a1 = avalancheWithCoords("3irti325", true, 38.2452, -103.463456546,
  ...
  val a2 = avalancheWithCoords("5ifki49e", true, 45.294955, -99.3959532,
