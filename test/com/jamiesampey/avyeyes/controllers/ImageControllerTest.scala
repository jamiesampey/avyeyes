...
import com.jamiesampey.avyeyes.service.{AmazonS3Service, ExternalIdService}
import com.jamiesampey.avyeyes.util.Constants.{MaxImagesPerAvalanche, ScreenshotFilename}
